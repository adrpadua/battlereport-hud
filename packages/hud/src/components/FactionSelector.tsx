...
interface FactionSelectorProps {
  onContinue?: (factions: [string, string]) => void;
}

export function FactionSelector({ onContinue }: FactionSelectorProps): React.ReactElement {
  ...
  const handleContinue = (): void => {
    ...
    const factions: [string, string] = [player1Faction, player2Faction];
